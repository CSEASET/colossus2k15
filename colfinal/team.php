...
<head>
        ...
        <title>Team | Colossus v5.0</title>
        ...
        <meta property="og:url" content="gallery2.html" />
        <meta property="og:image" content="./assets/design/images/logo.html" />
        ...
        <link rel="stylesheet" href="./assets/themeclubcube-design/css/team.css" type="text/css" />
		<script>
			var designUrl = './assets/themeclubcube-design/index.html';
		</script>
    ...
    echo <<<HTML
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-3 m_xs_bottom_30">
                     <figure class="t_align_c">
                         <img src="./assets/images/team/$img" alt="" class="r_corners m_bottom_23" width="220"
                              height="147">
                         <figcaption>
                             <h4 class="m_bottom_5"><a href="#" class="color_dark">$name</a></h4>
                             <i class="color_grey fs_medium d_inline_b m_bottom_5" style="padding-top: 5px;">$post</i>
                             <ul class="d_inline_b social_icons">
                                 <li class="m_right_5 d_inline_m m_bottom_5"><a href="$fb"
                                                                                target="_blank"
                                                                                class="color_grey_light_2 facebook circle icon_wrap_size_1 d_block target="
                                                                                _blank""><i
                                         class="fa fa-facebook"></i></a></li>
                                 <li class="m_right_5 d_inline_m m_bottom_5"><a href="mailto:$mail"
                                                                                class="color_grey_light_2 googleplus circle icon_wrap_size_1 d_block"><i
                                             class="fa fa-send"></i></a></li>
                                 <li class="m_right_5 d_inline_m m_bottom_5"><a href="tel:+91-$tel"
                                                                                class="color_grey_light_2 twitter circle icon_wrap_size_1 d_block"
                                                                                data-title="+91-$tel"><i
