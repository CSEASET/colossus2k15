...
<head>
        ...
        <title>Contact Us | Colossus v5.0</title>
        ...
        <meta property="og:title" content="Contacts / MODX Revolution" />
		...
		<div class="row">
			...
			<nav class="collapse navbar-collapse col-lg-8 main-navig" id="navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="last active"><span>Contact US</span></li>
	...
	<div class="container">
		<div class="row head">
            <div class="col-xs-12 col-sm-12 col-md-12 content-header__center-list">
				<h1 class="content-h1 text-left">Contact Us</h1>
			</div>
		</div>
	</div>
</section>
...
<ul>
<li><b>Country:</b> </li>
<li><b>City:</b> Bijwasan New Delhi, DL 110061</li>
<li><b>Address:</b> 580 Najafgarh Kapashera Rd</li>
<li><b>Phone no:</b> (011) 2806 2106</li>
</ul>
                            ...
                            <div class="col-lg-6 contact-block">
                                ...
                                <form class="form-horizontal" id="contactForm" action="http://sites.makebecool.com/colossus/ajax/formcontacts" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <input type="email" name="email" class="form-control required email" required id="inputEmail" placeholder="E-mail:">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <button type="submit" class="read-more submit">Send</button>
                                        </div>
                                    </div>
                                ...
                                <div id="successMessage" class="suc" style="display: none;">
                                    <div class="suc-title"><span class="glyphicon glyphicon-ok"></span>Thank you, your message has been sent.</div>
                                </div>
                            </div>
                        </div>
					</div>
